  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/RiteshSharmaop/TodoApp">
        ...
        <MenuLink to="https://github.com/RiteshSharmaop/TodoApp/issues/new">
          <StyledMenuItem>
        ...
        <MenuLink to="https://www.buymeacoffee.com/riteshlnct3">
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/RiteshSharmaop"
            >
              RiteshSharmaop
            </a>
          </CreditsContainer>
